                    ...
                    <div class="ca__imgs">
                        <?php foreach ($muCategory as $muInfo) : ?>
                            <div class="img1 imgcontainer">
                                <a href="http://ljy16.dothome.co.kr/myuduck/musical/category_mu_detail.php?musicalId=<?php echo $muInfo['musicalId']; ?>"><img src="<?php echo $muInfo['muImg']; ?>" alt="<?php echo $muInfo['muNameKo']; ?>"></a>
                                <div class="text">
